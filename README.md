> Personal Note (Feb 2024):  Phormer has been a pet project back in 2007.  It is no longer maintained.  However, it should still work, even with PHP 8. ^_^

About:
===
Phormer is featureful a Photo Gallery Manager in PHP (and no MySQL)!
* Homepage: https://p.horm.org/er
* Demo: https://p.horm.org
* Former Project Home: https://sourceforge.net/projects/rephormer/ (Since 2007)


Installation Instructions:
====================
1. Download the latest version of phormer###.zip from http://p.horm.org/er (or `/bin` folder here)
2. Unzip the `phormer###.zip` file (~90KB) to the destination folder on your 
     server (e.g. `/var/www/photos`). (Hint: type this command: "`unzip phormer###.zip`"
     in the shell).
3. Load that by a web browser (e.g. `http://somewhere/photos`) and fill the 
...
completed, turn them back to `711`.

Briefly, after uploading, the following 
...
==============
 ...
 3. Go to administration area (http://example.com/photos/admin.php) and work 
...
This Readme is Last-Updated on 2024/02/07 by Aidin NasiriShargh [http://i.horm.org].
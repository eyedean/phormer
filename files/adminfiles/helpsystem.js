...
function ShowHelp(s, eve, lang, val) {
	if ((dgp('helpBoxLegend').innerHTML == val)) {
		HideHelp();
		return;
	}
	dont_help = false;
	...
	dgp('helpBoxLegend').innerHTML = /* 'Help : ' + */ val;
	if (lang == 'fa')
		dgp('helpBoxLegend').dir = 'rtl';
	...
	switch (lang) {
		...
		//case 'fa':			helpMsg = GetFaHelpMsg(s); break;		
